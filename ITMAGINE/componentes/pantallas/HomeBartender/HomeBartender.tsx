...
const componentes:any = [<ListadoProductos estado='por preparar' tipo="bartender"></ListadoProductos>, <ListadoProductos estado='en preparacion' tipo="bartender"></ListadoProductos>];
